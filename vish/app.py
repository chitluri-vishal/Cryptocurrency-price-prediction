...
fig.update_layout(title='Compare last 15 days vs next 30 days', xaxis_title='Timestamp', yaxis_title='Stock price', plot_bgcolor='white', font_size=15, font_color='black', legend_title_text='Close Price')
...
def index():
    ...
    return render_template('index.html', plot_div=plot_div,lstmdf=lstmdf)
